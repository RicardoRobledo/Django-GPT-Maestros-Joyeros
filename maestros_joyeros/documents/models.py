...
class DocumentModel(BaseModel):
    ...
    for_workshop = models.BooleanField(default=True, null=False, blank=False)
    for_simulation = models.BooleanField(default=True, null=False, blank=False)
    topic_id = models.ForeignKey(
        TopicModel, null=False, blank=False, on_delete=models.CASCADE)
