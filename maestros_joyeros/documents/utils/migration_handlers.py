import os
from maestros_joyeros.base.utils.file_handlers import read_document_files
...
def insert_initial_data(apps, schema_editor):
    ...
    for folder_path, topic_classifieds in zip(folder_paths, topic_names_classified):
        ...
        for topic_classified in topic_classifieds:
            documents_gotten = read_document_files(
                f'{folder_path}/{topic_classified}', topic_classified)
