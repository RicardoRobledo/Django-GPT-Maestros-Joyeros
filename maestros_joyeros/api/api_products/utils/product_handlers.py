...
def prepare_product():
    ...
    product_name_selected = random.choices(
        product_names, weights=product_weights, k=1)[0]
    product_selected = products.filter(
        product_name=product_name_selected).first()
