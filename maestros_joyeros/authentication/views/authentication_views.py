...
from maestros_joyeros.api.api_authentication.utils import token_handlers
...
class LoginView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not user:
            return HttpResponse(content='Error, user not found', status=HTTPStatus.UNAUTHORIZED)
