...
def read_product_files(folder_path):
    ...
    for file in files:
        ...
        with open(f'{folder_path}/{file}', 'r', encoding='utf-8') as file_instance:
            ...
            product_object = ProductModel(product_name=file_name, description=content)
...
def read_customer_files(folder_path):
    ...
    for file in files:
        ...
        with open(f'{folder_path}/{file}', 'r', encoding='utf-8') as file_instance:
            ...
            customer_object = CustomerModel(customer_type=file_name, description=content)
...
def read_document_files(folder_path, topic_name):
    ...
    for file in files:
        ...
        with open(f'{folder_path}/{file}', 'r', encoding='utf-8') as file_instance:
            ...
            document_object = DocumentModel(document_name=file_name, content=content, topic_id=topic)
