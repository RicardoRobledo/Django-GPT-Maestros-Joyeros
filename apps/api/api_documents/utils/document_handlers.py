...
__author__ = 'Ricardo'
__version__ = '1.0'
__all__ = ['get_context_documents', 'get_documents', 'get_document', 'get_documents_not_evaluated']
...
def get_context_documents():
    ...
    document_names_selected = random.choices(document_names, weights=document_weights, k=2)
    documents_selected = DocumentModel.objects.filter(document_name__in=document_names_selected)
