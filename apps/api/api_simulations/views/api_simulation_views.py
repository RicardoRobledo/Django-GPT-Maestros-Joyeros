...
def get_simulation(request):
    ...
    formatted_output = format_simulation_prompt('apps/api/api_simulations/schemas/prompt_simulation.txt', product, customer, documents)
...
def get_custom_simulation(request):
    ...
    formatted_output = format_simulation_prompt('apps/api/api_simulations/schemas/prompt_custom_simulation.txt', product, None, documents)
    user_handlers.register_action(request=request, status_code=status.HTTP_200_OK)
...
def retrieve_instructions(request):
    ...
    instructions = read_prompt('apps/api/api_simulations/schemas/prompt_evaluation_instructions.txt')
